...
export function defineDibThemes(monaco: Parameters<OnMount>[1]) {
  ...
  monaco.editor.defineTheme(THEME_DARK, {
    ...
    inherit: true,
    rules: [
      { token: "comment", foreground: "5F6C81", fontStyle: "italic" },
      ...
      { token: "operator", foreground: "94A1B5" },
      { token: "identifier", foreground: "EAEEF6" },
      { token: "type", foreground: "818cf8" },
      { token: "predefined", foreground: "22d3ee" },
    ],
    colors: {
      "editor.background": "#0F131A",
      "editor.foreground": "#EAEEF6",
      ...
      "editorWhitespace.foreground": "#242C3A",
      "editorIndentGuide.background": "#242C3A",
      "editorIndentGuide.activeBackground": "#f472b633",
      "editorLineNumber.foreground": "#5F6C81",
      "editorLineNumber.activeForeground": "#94A1B5",
      "editor.selectionHighlightBackground": "#f472b618",
      "editorBracketMatch.background": "#f472b622",
      "editorBracketMatch.border": "#f472b6",
      "scrollbarSlider.background": "#242C3A80",
      "scrollbarSlider.hoverBackground": "#f472b633",
      "scrollbarSlider.activeBackground": "#f472b655",
      "editorSuggestWidget.background": "#151A23",
      "editorSuggestWidget.border": "#242C3A",
      "editorSuggestWidget.foreground": "#EAEEF6",
      "editorSuggestWidget.selectedBackground": "#f472b614",
      "editorSuggestWidget.highlightForeground": "#f472b6",
      "editorHoverWidget.background": "#151A23",
      "editorHoverWidget.border": "#242C3A",
    },
  });
}
