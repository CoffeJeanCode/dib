# Graph Report - dib  (2026-07-07)

## Corpus Check
- 162 files · ~122,697 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1613 nodes · 3219 edges · 126 communities (98 shown, 28 thin omitted)
...
- [[_COMMUNITY_PasswordPrompt.tsx|PasswordPrompt.tsx]]
...
- `ColumnListProps` --references--> `ColumnInfo`  [EXTRACTED]
  src/features/Sidebar/Parts/ColumnList.tsx → src/types/db.ts
...
Cohesion: 0.09
Nodes (50): DEFAULT_COL_W_EXPORT, DataGrid, DataGridProps, EditState, makeEditState(), Snapshot, useDataGridState(), ARROW_KEYS (+42 more)
...
Cohesion: 0.07
Nodes (81): Box, ConnectionInfo, DashMap, RwLock, assert_connection_in_active_workspace(), connect_db_lazily(), connect_saved(), connect_to_db() (+73 more)

### Community 5 - "Community 5"
Cohesion: 0.11
Nodes (18): Action, ACTION_LABEL, ACTION_TITLE, DbActionDialog(), DbActionDialogProps, ConnectionManagerProps, PasswordPrompt(), PasswordPromptProps (+10 more)
...
Cohesion: 0.13
Nodes (28): MainContent(), Props, ENGINE_COLORS, HomeView(), HomeViewProps, ConnectionStatusDotProps, STATUS_CLASS, WorkspaceList() (+20 more)

### Community 8 - "Community 8"
Cohesion: 0.15
Nodes (16): CommitFooter(), CommitFooterProps, defaultTableTabState(), fmtErr(), QueryPanel(), tableTabId(), TableTabState, ArrowMenuNavOptions (+8 more)
...
Cohesion: 0.32
Nodes (7): ChangeKind, COMMON_TYPES, generateAlterSql(), KIND_OPTIONS, SchemaChangeWizard(), SchemaChangeWizardProps, SchemaChange
...
Cohesion: 0.15
Nodes (13): ConnectionManager(), SystemInfo, SystemStatusBar(), DbActionType, Panel, Sidebar(), SidebarProps, connectionService (+5 more)
...
Cohesion: 0.13
Nodes (24): QueryPanelProps, CATEGORIES, CatKey, DDL_TEMPLATES, fmtErr(), useDatabaseCategoriesLogic(), ColumnList, ColumnListProps (+16 more)
...
Cohesion: 0.09
Nodes (23): QueryHistoryPanelProps, timeAgo(), SUB_ICONS, SUB_LABELS, SubTab, TableStructureView(), TableStructureViewProps, dbService (+15 more)
...
Cohesion: 0.15
Nodes (17): CommandAction, CommandPalette(), CommandPaletteProps, DbObjectSubtype, DDL_MODE_META, DdlMode, generateOrmAlias(), getPaletteItemHint() (+9 more)
...
Cohesion: 0.15
Nodes (20): App(), HOME_PANELS, Layout(), LayoutProps, Panel, SPLIT_PANELS, UNIFIED_PANELS, DDL_TEMPLATE (+12 more)
...
Cohesion: 0.22
Nodes (6): getFileIcon(), TreeItem(), TreeItemProps, WorkspaceTree, WorkspaceTreeProps, WorkspaceTreeRef
...
Cohesion: 0.14
Nodes (24): InstanceSelectorDropdown(), InstanceSelectorDropdownProps, ConnectionItem(), ConnectionItemProps, ConnectionStatusDot(), DatabaseCategories(), DatabaseSelector(), DatabaseSelectorProps (+16 more)
...
Cohesion: 0.05
Nodes (46): KeyboardCheatSheet(), KeyboardCheatSheetProps, SECTIONS, Props, MonacoEditor(), MonacoEditorProps, EmptyWorkspaceState(), k() (+38 more)

### Community 42 - "Community 42"
Cohesion: 0.13
Nodes (20): childNodeType(), ConnectionTreeRoot(), DatabaseTree(), DatabaseTreeProps, FolderDef, FolderRow(), FolderRowProps, GLOBAL_FOLDERS (+12 more)
...
Cohesion: 0.24
Nodes (9): FAKER_TYPES, MockGenerator(), Props, ToastContainer(), ToastItem(), Toast, ToastState, ToastType (+1 more)
...
### Community 63 - "PasswordPrompt.tsx"
Cohesion: 0.10
Nodes (24): GlobalModals(), GlobalModalsProps, reopenPaletteOnDismiss(), appWindow, Titlebar(), LAYOUT_OPTIONS, SettingsPanel(), SettingsPanelProps (+16 more)
...
Cohesion: 0.60
Nodes (3): persistenceService, DEFAULT_STATE, UiState
...
Cohesion: 0.50
Nodes (4): JsonPanel(), ROW_LIMITS, rowsToObjects(), JsonViewer()
...
## Knowledge Gaps
- **406 isolated node(s):** `$schema`, `plugin`, `@opencode-ai/plugin`, `name`, `private` (+401 more)
...
- **Why does `DbState` connect `Community 4` to `Community 64`, `Community 26`?**
