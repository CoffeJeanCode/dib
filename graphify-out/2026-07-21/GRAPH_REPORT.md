# Graph Report - dib  (2026-07-17)

## Corpus Check
- 166 files · ~144,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2529 nodes · 5996 edges · 180 communities (138 shown, 42 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 547 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1678963`
...
- [[_COMMUNITY_filesrchooksuseSavedConnections.ts@srchooksuseSavedConnections.ts|file:src/hooks/useSavedConnections.ts@src/hooks/useSavedConnections.ts]]
- [[_COMMUNITY_Kr|Kr]]
- [[_COMMUNITY_bv|bv]]
- [[_COMMUNITY_wa|wa]]
- [[_COMMUNITY_Capability|Capability]]
...
5. `x0()` - 93 edges
6. `ae()` - 86 edges
7. `QueryError` - 75 edges
8. `ne()` - 48 edges
9. `useWorkspaceStore` - 45 edges
10. `DbState` - 44 edges
...
## Communities (180 total, 42 thin omitted)
...
Cohesion: 0.15
Nodes (22): ExplainNode, PgArguments, PgPool, PgRow, build_where_pg(), decode_fk_action(), execute_query_inner(), execute_query_no_tx() (+14 more)
...
Cohesion: 0.05
Nodes (93): _(), a_(), Aa(), ag(), ah(), ai, Ar, aT() (+85 more)
...
Cohesion: 0.11
Nodes (21): AtomicI32, From, pg_cast_suffix(), PostgresDriver, qualified(), ColumnInfo, CreateColumn, DbConfig (+13 more)
...
### Community 13 - "g0"
Cohesion: 0.13
Nodes (13): bN(), c1(), d0(), ey(), h0(), Ic(), Io(), Ju() (+5 more)
...
Cohesion: 0.16
Nodes (30): ChangeRow, ColumnInfo, ColumnMetadata, ConnectionInfo, ConnectionStatus, CreateColumn, DbConfig, DbTreeNode (+22 more)
...
Cohesion: 0.12
Nodes (10): ScriptsContextMenu(), ScriptsContextMenuProps, getFileIcon(), TreeItem(), TreeItemProps, WorkspaceTree, WorkspaceTreeProps, WorkspaceTreeRef (+2 more)
...
Cohesion: 0.06
Nodes (60): QueryPanelProps, FullSchemaView(), gridLayout(), nodeTypes, SchemaVisualizerProps, CATEGORIES, CatKey, fmtErr() (+52 more)
...
### Community 25 - "Bb"
Cohesion: 0.05
Nodes (66): ap(), aS(), Ay(), Bb(), bE(), bp(), Bs(), cA (+58 more)

### Community 26 - "ne"
Cohesion: 0.07
Nodes (40): Ab(), af(), bf(), By(), C0(), db(), Dl, dw() (+32 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (44): CommandAction, CommandPalette(), CommandPaletteProps, DbObjectSubtype, DDL_MODE_META, DdlMode, generateOrmAlias(), getPaletteItemHint() (+36 more)
...
Cohesion: 0.07
Nodes (56): DEFAULT_COL_W_EXPORT, DataGrid, DataGridProps, EditState, makeEditState(), Snapshot, useDataGridState(), isFormElementFocused() (+48 more)
...
### Community 36 - "Ac"
Cohesion: 0.08
Nodes (39): a1(), Ac(), Au(), Cl(), co(), cy(), d1(), ds() (+31 more)
...
Cohesion: 0.13
Nodes (21): cp(), cS(), dn(), hf(), Hu(), i0(), Mr(), Nr() (+13 more)
...
Cohesion: 0.08
Nodes (25): JsonPanel(), ROW_LIMITS, rowsToObjects(), JsonViewer(), Props, MonacoEditor(), MonacoEditorProps, SqlEditor() (+17 more)

### Community 42 - "Community 42"
Cohesion: 0.10
Nodes (28): Action, ACTION_LABEL, ACTION_TITLE, DbActionDialog(), DbActionDialogProps, GlobalModals(), GlobalModalsProps, reopenPaletteOnDismiss() (+20 more)
...
Cohesion: 0.08
Nodes (23): eC(), eg(), f0(), Fc(), Hp(), In(), _k, Ll (+15 more)

### Community 57 - "TableActionsMenu.tsx"
Cohesion: 0.09
Nodes (21): KeyboardCheatSheet(), KeyboardCheatSheetProps, SECTIONS, GridFooter, EmptyWorkspaceState(), Shortcut, SHORTCUTS, ICON_MAP (+13 more)
...
Cohesion: 0.13
Nodes (15): CC(), f3(), Fs(), gk, i3(), Ld(), Lr(), nj() (+7 more)
...
Cohesion: 0.12
Nodes (20): bv(), cR(), d_(), Da(), ew(), fv(), Gf(), jM() (+12 more)
...
Cohesion: 0.08
Nodes (38): _2(), am(), ax(), bA(), bT(), Cg(), Ch(), dR() (+30 more)
...
Cohesion: 0.29
Nodes (17): fetch_db_node_children(), fetch_schema_objects(), fetch_table_relations(), fetch_table_schema(), get_node_children(), get_table_structure(), invalidate_node_cache(), ColumnInfo (+9 more)

### Community 112 - "Community 112"
Cohesion: 0.28
Nodes (9): bh(), Fh(), gb(), Gd(), my(), py(), ub(), Wl() (+1 more)
...
Cohesion: 0.28
Nodes (9): bu(), hD(), l1(), p0(), Pd(), Pg(), Su(), _u() (+1 more)
...
Cohesion: 0.08
Nodes (31): ADVANCE_PANELS, HOME_PANELS, Layout(), LayoutProps, Panel, SIMPLE_PANELS, appWindow, Titlebar() (+23 more)

### Community 128 - "useWorkspaceStore"
Cohesion: 0.18
Nodes (13): av(), D2(), eN(), iv(), l2(), ln(), lv(), nN() (+5 more)
...
Cohesion: 0.08
Nodes (53): App(), MainContent(), Props, DDL_TEMPLATE, ConnectionManagerProps, ENGINE_COLORS, HomeView(), HomeViewProps (+45 more)

### Community 131 - "file:src/components/Layout.tsx@src/components/Layout.tsx"
Cohesion: 0.11
Nodes (16): cv(), Dc(), du(), fp(), hE(), Jo(), n(), qM() (+8 more)

### Community 132 - "SchemaChangeWizard.tsx"
Cohesion: 0.23
Nodes (20): ARROW_KEYS, CellCoord, focusFirstCell(), GridKeyDownDeps, handleCtrlClipboard(), handleCtrlRows(), handleCtrlSaveUndo(), handleCtrlWorkspace() (+12 more)
...
### Community 138 - "Ka"
Cohesion: 0.33
Nodes (9): Ci(), e0(), ip(), lp(), st(), t0(), Ws(), xp() (+1 more)

### Community 139 - "Sa"
Cohesion: 0.20
Nodes (16): ConnectionItem(), ConnectionStatusDot(), ConnectionStatusDotProps, STATUS_CLASS, DatabaseCategories(), DatabaseSelector(), DropdownItem, DbContextMenu() (+8 more)
...
### Community 145 - "Ri"
Cohesion: 0.27
Nodes (12): ef(), Fr(), g0(), Gl(), ha(), Kb(), od(), So() (+4 more)
...
### Community 157 - "fw"
Cohesion: 0.31
Nodes (9): b0(), jb(), k0(), Kt(), Ny(), Qb(), R1(), Yb() (+1 more)
...
### Community 171 - "file:src/hooks/useSavedConnections.ts@src/hooks/useSavedConnections.ts"
Cohesion: 0.50
Nodes (4): description, required, type, Capability
...
### Community 175 - "Capability"
Cohesion: 0.50
Nodes (4): description, required, type, Capability

### Community 176 - "file:src/components/EmptyWorkspaceState.tsx@src/components/EmptyWorkspaceState.tsx"
Cohesion: 0.67
Nodes (3): El(), ii(), np()
...
- **Why does `r()` connect `JsonPanel.tsx` to `useWorkspaceStore`, `vc`, `file:src/components/Layout.tsx@src/components/Layout.tsx`, `Community 5`, `z3`, `Community 7`, `Zo`, `Ka`, `g0`, `Ri`, `file:src/components/EmptyWorkspaceState.tsx@src/components/EmptyWorkspaceState.tsx`, `la`, `Community 23`, `Bb`, `ne`, `Community 27`, `fw`, `hv`, `Community 31`, `Xt`, `lM`, `o3`, `Ac`, `tp`, `Community 38`, `.constructor`, `wa`, `file:src/components/EmptyWorkspaceState.tsx@src/components/EmptyWorkspaceState.tsx`, `Community 56`, `useKeybindings.ts`, `DbActionDialog.tsx`, `Community 69`, `Community 112`, `r`, `Community 119`, `useTreeKeyboardNav`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `t()` connect `useKeybindings.ts` to `useWorkspaceStore`, `vc`, `file:src/components/Layout.tsx@src/components/Layout.tsx`, `Community 5`, `z3`, `Community 7`, `x0`, `db.rs`, `Ka`, `Zo`, `g0`, `qg`, `Ri`, `la`, `Community 23`, `Bb`, `ne`, `Community 27`, `fw`, `hv`, `Xt`, `lM`, `tp`, `Ac`, `Community 38`, `Community 41`, `bv`, `wa`, `file:src/components/EmptyWorkspaceState.tsx@src/components/EmptyWorkspaceState.tsx`, `m3`, `Community 56`, `DbActionDialog.tsx`, `Community 69`, `JsonPanel.tsx`, `Community 112`, `r`, `Community 119`, `useTreeKeyboardNav`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `safeInvoke()` connect `Community 23` to `WorkspaceTree.tsx`, `Community 42`, `Sa`, `JsonPanel.tsx`, `Community 12`, `qg`, `SettingsPanel.tsx`, `Community 31`?**
...
- **Are the 72 inferred relationships involving `s()` (e.g. with `_()` and `_2()`) actually correct?**
  _`s()` has 72 INFERRED edges - model-reasoned connections that need verification._