...
## Corpus Check
- 166 files · ~126,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1639 nodes · 3297 edges · 136 communities (108 shown, 28 thin omitted)
...
- [[_COMMUNITY_uiStore.ts|uiStore.ts]]
- [[_COMMUNITY_useUiState.ts|useUiState.ts]]
...
- `TableStructureViewProps` --references--> `TableInfo`  [EXTRACTED]
  src/features/TableStructure/TableStructureView.tsx → src/types/db.ts

## Import Cycles
- None detected.

## Communities (136 total, 28 thin omitted)
...
Cohesion: 0.06
Nodes (82): Box, ConnectionInfo, DashMap, RwLock, assert_connection_in_active_workspace(), connect_db_lazily(), connect_saved(), connect_to_db() (+74 more)
...
Cohesion: 0.10
Nodes (28): SqliteArguments, SqlitePool, SqliteRow, build_where_sqlite(), is_select(), ColumnInfo, DbTreeNode, ExplainPlan (+20 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (21): childNodeType(), ConnectionTreeRoot(), DatabaseTree(), DatabaseTreeProps, FolderDef, FolderRow(), FolderRowProps, GLOBAL_FOLDERS (+13 more)

### Community 8 - "Community 8"
Cohesion: 0.22
Nodes (7): HOME_PANELS, LayoutProps, Panel, SPLIT_PANELS, UNIFIED_PANELS, SettingsState, WorkspaceLayout
...
Cohesion: 0.08
Nodes (39): AtomicI32, ExplainNode, PgArguments, PgPool, PgRow, build_where_pg(), decode_fk_action(), execute_query_inner() (+31 more)
...
Cohesion: 0.24
Nodes (9): appWindow, Titlebar(), Dropzone(), DropzoneProps, EXTENSIONS, formatOf(), ImportFormat, ImportResult (+1 more)
...
Cohesion: 0.15
Nodes (31): From, ChangeRow, ColumnInfo, ColumnMetadata, ConnectionInfo, ConnectionStatus, DbConfig, DbTreeNode (+23 more)
...
Cohesion: 0.22
Nodes (16): Props, workspaceService, collectFileNames(), fileNameFor(), migrateInternalToVirtual(), migrateInternalToWorkspace(), ActiveConn, JsonPanelData (+8 more)
...
Cohesion: 0.16
Nodes (23): CATEGORIES, CatKey, fmtErr(), useDatabaseCategoriesLogic(), DatabaseCategoriesProps, DatabaseCategoryItem, DatabaseCategoryItemProps, IconType (+15 more)
...
Cohesion: 0.40
Nodes (3): EmptyWorkspaceState(), Shortcut, SHORTCUTS
...
Cohesion: 0.18
Nodes (16): GridColumn, cellStr(), makeKey(), operatorsForType(), DataGridContext, DataGridContextValue, useDataGridContext(), FilterPopover (+8 more)
...
Cohesion: 0.16
Nodes (19): ConnectionItem(), ConnectionStatusDot(), ConnectionStatusDotProps, STATUS_CLASS, DatabaseCategories(), DatabaseSelector(), DropdownItem, DbContextMenu() (+11 more)
...
Cohesion: 0.13
Nodes (18): DataGrid, JsonViewer(), Props, MonacoEditor(), MonacoEditorProps, k(), SqlEditor(), SqlEditorProps (+10 more)

### Community 42 - "Community 42"
Cohesion: 0.18
Nodes (12): ICON_MAP, Tab(), TabData, TabPayload, TabProps, TabType, restrictToHorizontalAxis(), TabBar() (+4 more)
...
Cohesion: 0.16
Nodes (16): ENGINE_COLORS, HomeView(), HomeViewProps, WorkspaceList(), WorkspaceListProps, DangerConfirmDialog(), Props, Skeleton() (+8 more)
...
Cohesion: 0.15
Nodes (17): defaultTableTabState(), fmtErr(), persistScopeTabCache(), QueryPanel(), QueryPanelProps, ScopeSnapshot, scopeTabCache, tableTabId() (+9 more)
...
Cohesion: 0.26
Nodes (11): App(), Layout(), MainContent(), DDL_TEMPLATE, DDL_TEMPLATES, Options, useAppKeybindings(), useKeybindings() (+3 more)
...
Cohesion: 0.13
Nodes (20): ConnectionManager(), ConnectionManagerProps, InstanceSelectorDropdown(), InstanceSelectorDropdownProps, ConnectionItemProps, DatabaseSelectorProps, SystemInfo, SystemStatusBar() (+12 more)

### Community 127 - "SettingsPanel.tsx"
Cohesion: 0.23
Nodes (9): LAYOUT_OPTIONS, SettingsPanel(), SettingsPanelProps, getTheme(), setTheme(), useTheme(), useUiState(), FlatInput (+1 more)

### Community 128 - "useWorkspaceStore"
Cohesion: 0.24
Nodes (10): JsonPanel(), ROW_LIMITS, rowsToObjects(), QueryHistoryPanel(), QueryHistoryPanelProps, timeAgo(), Sidebar(), useSidebarScripts() (+2 more)

### Community 129 - "Value"
Cohesion: 0.24
Nodes (8): GlobalModals(), GlobalModalsProps, reopenPaletteOnDismiss(), KeyboardCheatSheet(), KeyboardCheatSheetProps, SECTIONS, RenameDialog(), RenameDialogProps
...
### Community 133 - "uiStore.ts"
Cohesion: 0.43
Nodes (3): RecentCommand, Theme, UiState

### Community 134 - "useUiState.ts"
Cohesion: 0.60
